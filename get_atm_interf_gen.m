function [dt, da, dg, Ht, Ha, Hg] = get_atm_interf_gen (e, H, N, de, der, opt)
...
%    opt.H_numerical [scalar, boolean] obtain altimetry correction numerically? (defaults to false)
